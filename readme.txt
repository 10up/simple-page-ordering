...
* **Changed:** Bump `@babel/traverse` from `7.20.12` to `7.23.6` (props [@dependabot](https://github.com/apps/dependabot), [@ravinderk](https://github.com/ravinderk)) via [#184](https://github.com/10up/simple-page-ordering/pull/184).
* **Changed:** Bump `sharp` from `0.30.7` to `0.32.1` (props [@dependabot](https://github.com/apps/dependabot), [@Sidsector9](https://github.com/Sidsector9)) via [#182](https://github.com/10up/simple-page-ordering/pull/184).
* **Changed:** Bump `10up-toolkit` from `4.3.1` to `5.2.2` (props [@dependabot](https://github.com/apps/dependabot), [@Sidsector9](https://github.com/Sidsector9)) via [#182](https://github.com/10up/simple-page-ordering/pull/182).
