...
npx wp-env run tests-cli "wp post create --post_type=post --post_title='Post One' --post_status='publish'"
npx wp-env run tests-cli "wp post create --post_type=post --post_title='Post Two' --post_status='publish'"

npx wp-env run tests-cli "wp plugin activate simple-page-ordering-helper"
